...
const helpTopics=[
  ...
  {id:"reports",label:"Gerar e imprimir fichas",permission:"reports.view",view:"reports",chapter:"manual-reports",answer:"Abra Relatórios, selecione empresa, filial, colaborador ou todos, turno se desejar e mês. Clique em “Gerar ficha”. Nas empresas e filiais autorizadas pelo Administrador Master, o Repouso Térmico recebe três intervalos automáticos com duração segura entre 20 e 25 minutos, calculados pelo turno, com variação de −15 a +15 minutos pelos 31 dias. Fora da autorização, os campos térmicos ficam em branco. A ficha de Refeição permanece manual."},
